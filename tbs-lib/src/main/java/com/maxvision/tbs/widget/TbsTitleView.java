package com.maxvision.tbs.widget;
 ...
 * desc：自定义标题
 */
public class TbsTitleView extends RelativeLayout {
    ...
    public TbsTitleView(Context context) {
        this(context, null);
    }

    public TbsTitleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TbsTitleView(Context context, AttributeSet attrs, int defStyleAttr) {
